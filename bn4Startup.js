...
export async function main(ns) {
  ...
  ns.run("SphyxOS/full/IPvGo.js", 1, "Daedalus", "The Black Hand", "Illuminati");
  ...
  ns.run("Batchers/1Thread/Manager.js", 1, "n00dles", "justPserv")

  while(ns.getPurchasedServers() != ns.getPurchasedServerLimit() || ns.getServerMaxRam(ns.getPurchasedServers().at(4)) < 32){
    await ns.sleep(1000)
  }
  ns.kill("Batchers/1Thread/Manager.js","home", "n00dles", "justPserv")
